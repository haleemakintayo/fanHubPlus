    ...
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-[#0D1117] text-neutral-900 dark:text-neutral-100">
      <header className="sticky top-0 z-40 w-full bg-[#FDFBF7] dark:bg-[#0D1117] border-b-2 border-black dark:border-neutral-100 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <h2 className="text-xl font-semibold">Fan Hub Plus</h2>
          {isAuthenticated ? (
            <button
              onClick={() => {
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[#A3E635] text-black font-semibold text-xs sm:text-sm uppercase tracking-tight border-2 border-black brutal-shadow brutal-btn hover:bg-[#86efac]"
            >
              Log In
            </button>
          )}
      ...
      <main className="flex-1 p-6">
        <h3 className="text-xl font-semibold mb-4">Welcome to Fan Hub Plus</h3>
        <p className="mb-4">
          Explore the universe of fandoms, characters, media, and events.
        </p>
      </main>
