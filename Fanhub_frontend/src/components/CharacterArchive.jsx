...
export default function CharacterArchive({ 
  ...
  return (
    <section id="characters" className="py-16 px-4 sm:px-6 lg:px-8 border-b-2 border-black dark:border-neutral-100 bg-[#FDFBF7] dark:bg-[#0D1117] transition-colors">

      <div className="max-w-7xl mx-auto">
        
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12 pb-6 border-b-2 border-black dark:border-neutral-800">
          <div>
            <div className="inline-flex items-center gap-2 mb-2">
              <span className="bg-[#A3E635] text-black font-black text-xs uppercase px-2.5 py-0.5 border-2 border-black brutal-shadow-sm">
                BIOGRAPHY REGISTRY
              </span>
          ...
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs font-bold uppercase px-3 py-1.5 bg-black text-[#FACC15] border-2 border-black">
              4 Featured Champions
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {characters.map((char) => {
            ...
            return (
              <div
                key={char.id}
                className="group bg-white dark:bg-[#161B22] border-3 border-black dark:border-white p-5 flex flex-col justify-between brutal-shadow-md hover:-translate-y-1 transition-transform relative"
              >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-4">
                    <span 
                      className="font-mono text-[11px] font-black uppercase px-2.5 py-0.5 border-2 border-black text-black"
                      style={{ backgroundColor: char.accentColor }}
                    >
                      {char.universe}
                    </span>
                  ...
                  <div className="relative aspect-square w-full mb-4 border-2 border-black overflow-hidden bg-neutral-900 group-hover:border-black transition-colors">
                    <img
                      src={char.image}
                      alt={char.name}
                    ...
                    <div className="absolute bottom-2 left-2 right-2">
                      <span className="font-mono text-[10px] font-black uppercase text-white bg-black/80 px-2 py-0.5 border border-white/30 block truncate">
                        {char.faction}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <h3 className="text-xl font-black uppercase tracking-tight text-black dark:text-white leading-tight">
                      {char.name}
                    </h3>
                    <p className="text-xs text-neutral-600 dark:text-neutral-400 italic mt-1 line-clamp-2">
                      {char.tagline}
                    </p>
                  </div>

                  {/* Power Statistics Breakdown */}
                  <div className="p-3 bg-neutral-50 dark:bg-[#0D1117] border-2 border-black dark:border-neutral-700 mb-4">
                    <span className="font-mono text-[10px] font-black uppercase text-neutral-500 block mb-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-3 bg-black text-white dark:bg-white dark:text-black font-black text-xs uppercase tracking-tight border-2 border-black dark:border-white brutal-shadow-sm brutal-btn flex items-center justify-center gap-1.5 mt-2"
